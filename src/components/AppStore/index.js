...
class AppStore extends Component {
  ...
  getFilteredApps = activeTabId =>
    appsList.filter(eachApp => eachApp.category === activeTabId)
  ...
  render() {
    ...
    const filteredAppsList = this.getFilteredApps(activeTabId)

    const filteredAppsBasedOnSearch = filteredAppsList.filter(eachApp =>
    ...
    return (
      <div className="bg-container">
        ...
        <ul className="apps-container">
          {filteredAppsBasedOnSearch.map(eachApp => (
